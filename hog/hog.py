...
def take_turn(num_rolls, opponent_score, dice=six_sided):
    ...
    if num_rolls == 0:
        ...
        #res = max(a, b) + 1
        return max(opponent_score // 10, opponent_score % 10)
    #else:
...
def play(strategy0, strategy1, goal=GOAL_SCORE):
    ...
    while(score<goal and opponent_score<goal):
        if(who == 0):
            ...
            opponent_score = opponent_score + take_turn(num_rolls, score, select_dice(score, opponent_score))
...
def max_scoring_num_rolls(dice=six_sided):
    ...
    while count < 11:
        print(count, 'dice scores', make_averaged(roll_dice)(count, dice), 'on average')
    return make_averaged(roll_dice)(count, dice)
