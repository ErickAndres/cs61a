...
class TestProblem9(AntTest):
    ...
    def test_double(self):
        ...
        self.assertEqual(armor, bee.armor, "Back damage incorrect" + str(back.double_damage) +' '+ str(back.damage))
        self.queen.action(self.colony)
        armor -= thrower_damage  # Queen should always deal normal damage
        self.assertEqual(armor, bee.armor, "Queen damage incorrect (2)" + str(self.queen.action))
        back.action(self.colony)
