...
# Name:Erick Andres, Andrea Melendez
# Email:eandres1@berkeley.edu, andymelendez@berkeley.edu
...
class Place:
    ...
    def remove_insect(self, insect):
        ...
        if type(insect) != QueenAnt or insect.num_of_queens > 1: 
...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, hive):
        ...
        while (current_place != hive and bee_distance < self.min_range):
            current_place = current_place.entrance
            bee_distance += 1
        while (current_place != hive and bee_distance < self.max_range):
            ...
            while place is not None:
                if place.ant: 
                    if place.ant.double_damage == False:
                        place.ant.damage *= 2 
                        if type(place.ant) is BodyguardAnt:
                            if place.ant.ant.double_damage == False:
                                place.ant.ant.damage *= 2
                                place.ant.ant.double_damage = True
...
def make_slow(action):
    ...
    """
    def temporary_action(self, colony):
        if colony.time % 2 == 0: 
...
def apply_effect(effect, bee, duration):
    ...
    temporary_action = effect(original_action)
    time = 0
    def change_action(colony):
        ...
        if time < duration:
            time += 1
            return temporary_action(bee, colony)
        else:
